 ...
 * @author W.Elsinga
 */
public class WhatsAPPshare extends URLBuilder {

    /**
     * Twitter native package name
     */
    private static final String WHATS_PACKAGE = "com.whatsapp";


    /**
     * URL to tweet to Twitter
     */
    private static final String WHATS_URL = "com.whatsapp";
